...
class IonSDKSFU extends IonService {
  ...
  late Client _sfu;
  Function(MediaStreamTrack track, RemoteStream stream, String uid)? ontrack;
  ...
  Future<void> connect() async {
    ...
    _sfu.ontrack = (MediaStreamTrack track, RemoteStream stream, String uid) =>
        ontrack?.call(track, stream, uid);
    _sfu.ondatachannel =
